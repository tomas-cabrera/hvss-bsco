...
# Get cluster list
cmc_cluster_list = hvss_utils.CMC_CLUSTER_LIST
...
for cmc_cluster in tqdm(cmc_cluster_list):
    ...
    if cmc_cluster not in ["N8e5_rv2_rg2_Z0.002", "N8e5_rv4_rg20_Z0.002", "N4e5_rv4_rg20_Z0.002"]:
        continue
    ...
    try:
        fb_input = gen_fb_input(
            hvss_utils.CMC_PATH + cmc_cluster + ".tar.gz", N, seed_max
        )
