...
We add additional parameters to track stellar object type, distinguishing between stars and compact objects.%, using the numbering convention of \citet{2002MNRAS.329..897H}; similarly, we implement the collision matrix presented in Table 2 of the same paper to determine the type of any post-merger products.
...
\textbf{We note that 50(90)\% of ejections occur before our synthetic population is \variable{output/mwej_rates.txt}old, and that naturally the earliest ejections are most dependent on any time variability in the MW potential.}
